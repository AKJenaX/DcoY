"""Sidebar status monitors, navigation lists, and report compiler controls."""
    ...
    with st.sidebar:
        ...
        st.markdown(
            ...
            <div style="text-align: center; margin-bottom: 1.5rem; border-bottom: 1px solid var(--border-color); padding-bottom: 1rem;">
              ...
              <span style="font-size: 0.6rem; color: var(--muted); letter-spacing: 0.5px; text-transform: uppercase;">Enterprise SOC Portal</span>
            </div>
            """,
        ...
        # Controls panel
        st.markdown("<p style='font-size: 0.65rem; color: var(--muted); text-transform: uppercase; font-weight: 600; letter-spacing: 0.5px; margin-bottom: 0.5rem; padding-left: 0.5rem;'>OPERATOR PANEL</p>", unsafe_allow_html=True)
